...
import { isValidAcademicEmail } from "../utils/helpers";
...
export default function AuthPage({ onSuccess }: AuthPageProps) {
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    if (!isValidAcademicEmail(email)) {
      setErrorMsg("Please enter a valid, complete academic/institutional email address.");
      return;
    }
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    if (!isValidAcademicEmail(email)) {
      setErrorMsg("Please enter a valid, complete academic email address.");
      return;
    }
    setErrorMsg("");
    setSuccessMsg("");
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-15 text-center">
        ...
        <p className="mt-2 text-xs text-slate-500 font-mono tracking-wider uppercase">
        ...
        <div className="bg-white py-10 px-6 sm:px-10 border border-slate-100 rounded-[2.5rem] shadow-xl shadow-slate-100/50 space-y-6">
          ...
          {forgotMode ? (
            ...
            <form onSubmit={handleForgotPassword} className="space-y-6">
              ...
              <div>
                <label htmlFor="reset-email" className="block text-[11px] font-bold font-mono text-slate-500 uppercase tracking-widest mb-1.5">
                  Academic Email
                </label>
            ...
            <>
              <form onSubmit={handleEmailAuth} className="space-y-5">
                {isSignUp && (
                  <>
                    ...
                    >
                      <label htmlFor="reg-name" className="block text-[11px] font-bold font-mono text-slate-500 uppercase tracking-widest mb-1.5">
                        Your Full Name
                      </label>
                      <input
                        id="reg-name"
                    ...
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                    >
                      <label htmlFor="exam-select" className="block text-[11px] font-bold font-mono text-slate-500 uppercase tracking-widest mb-1.5">
                        Select Target Exam
                      </label>
                      <select
                        id="exam-select"
                ...
                <div>
                  <label htmlFor="auth-email" className="block text-[11px] font-bold font-mono text-slate-500 uppercase tracking-widest mb-1.5">
                    Academic Email
                  </label>
                  <div className="relative">
                    <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-300">
                ...
                <div>
                  <div className="flex justify-between items-center mb-1.5">
                    <label htmlFor="auth-pw" className="block text-[11px] font-bold font-mono text-slate-500 uppercase tracking-widest">
                      Password
                    </label>
                    {!isSignUp && (
                      <button
              ...
              <div className="relative my-6 select-none pointer-events-none">
                ...
                <div className="relative flex justify-center text-xs font-mono uppercase tracking-widest text-slate-500">
              ...
              >
                ...
                <svg className="w-4 h-4 mr-1 shrink-0" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="text-center pt-4">
                <button
                  ...
                  className="text-xs text-slate-600 hover:text-indigo-650 transition-colors font-semibold cursor-pointer"
                >
